...
from .models import LoginForm,MyPasswordResetForm,MyPasswordChangeForm,MySetPasswordForm
from django.contrib.auth.views import PasswordResetConfirmView

urlpatterns = [
    path('',views.home),
    path('about',views.about,name="about"),
    path('address/<rid>',views.delete),
    ...
    path('password-reset-confirm/<uidb64>/<token>/', auth_view.PasswordResetConfirmView.as_view(template_name='password_reset_confirm.html',form_class=MySetPasswordForm), name='password_reset_comfirm'),
